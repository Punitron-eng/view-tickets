...
const emit = defineEmits(['getCurrentDeliveryType']);
...
const getDeliveryTypeData = async (dataValue) => {
    emit('getCurrentDeliveryType', dataValue);
};
</script>
<template>
    <div class="domestic-intl-section-outer">
        ...
        <DropdownView v-model="domesticInternational" :options="domesticInternationalOptions" optionLabel="name" optionValue="value" optionImg="img" placeholder="Select an option" class="setting-dropdown" appendTo="self">
...
// .view-order-wrapper .p-dropdown-panel {
//     top: 99px !important;
// }
...
.select-options-dropdown .option-name {
    padding: 6px 0px;
    width: 100% !important;
}

<template>
  <input :type="inputType" :id="id" :class="twClasses" :placeholder="placeholder" v-model="formattedModel" :maxlength="maxLength" class="base-input px-3 py-2 border rounded dark:bg-transparent leading-5" />
</template>
<script setup>

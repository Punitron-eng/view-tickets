...
<template>
    <BaseDropdown :options="options" :placeholder="placeholder ? placeholder : 'Select Store'" id="stores-dropdown-base"
        class="stores-dropdown-base" :tw-classes="twClasses ? twClasses : ``" @listen-dropdown-change="(e: any) => $emit('listenDropdownChange', e)" :virtualScrollerOptions="virtualScrollerOptions ? virtualScrollerOptions : { itemSize: 22 }" />
</template>

<style lang="scss">
@import '../../assets/itl-common-css/common-css.scss';

#stores-dropdown-base {
    .p-inputtext {
        padding: 0px;
    }
...
#stores-dropdown-base.p-inputwrapper-focus {
    @include theme() {

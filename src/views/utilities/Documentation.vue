...
&#125;,</code></pre>
        ...
        <p>
            Freya provides 20 PrimeVue themes out of the box. Setup of a theme is simple by including the css of theme to your bundle that are located inside <span class="text-primary font-medium">public/theme/</span> folder such as

export const PUSHPULLSCANLIST = {
    NAME: 'PUSHPULLSCANLIST',
    ACTIONS: {
        ...
        GETABANDONEDMODALDATA: 'getAbandonedModalData',
    },
    MUTATIONS: {
        ...
        SETABANDONEDMODALDATA: 'setAbandonedModalData',
    ...
    GETTERS: {
        ...
        SENDABANDONEDMODALDATA: 'sendAbandonedModalData',

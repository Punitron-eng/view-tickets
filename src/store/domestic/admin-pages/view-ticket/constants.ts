export const NEWVIEWTICKET = {
    ...
    ACTIONS: {
        ...
        GETCHATTICKETMODALDATA: 'getChatTicketModalData',
        GETCHATMESSAGEDATA: 'getChatMessageData',
        GETNEWTICKETDATA: 'getNewTicketData',
    },
    MUTATIONS: {
        ...
        SETTICKETDEPARTMENTID: 'setTicketDepartmentId',
        CLEARTICKETDEPARTMENTID: 'clearTicketDepartmentId',

        SETSTOREDETAILS: 'setStoreDetails',
        SETSTOREMODALDATA: 'setStoreModalData',
        SETSTOREID: 'setStoreId',
        SETCHATTICKETMODALDATA: 'setChatTicketModalData',
        SETCHATMODALCHATSDATA: 'setChatModalChatsData',
        SETCURRENTCHATCOUNT: 'setCurrentChatCount',
        SETNEWTICKETSTATUS: 'setNewTicketStatus',
    },
    GETTERS: {
        ...
        GETTICKETDEPARTMENTID: 'getTicketDepartmentId',

        SENDSTOREDETAILS: 'sendStoreDetails',
        SENDSTOREID: 'sendStoreId',
        SENDSTOREMODALDATA: 'sendStoreModalData',
        SENDCHATTICKETMODALDATA: 'sendChatTicketModalData',
        SENDCHATMESSAGEDATA: 'sendChatMessageData',
        SENDCURRENTCHATCOUNT: 'sendCurrentChatCount',
        SENDNEWTICKETSTATUS: 'sendNewTicketStatus',
    },
};
